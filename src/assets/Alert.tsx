  ...
  return (
    ...
    <div style={alertStyle} >
      ...
      <div style={{display: 'flex', marginRight: '20px'}}>
        <i 
        style={{color: alert.value.type === 'success' ? 'green' : 'red', fontSize: 'large', marginRight: '5px'}} 
        className={alert.value.type === 'success' ? "bi bi-check-circle-fill" : 'bi bi-exclamation-circle-fill'}>        
        </i>
