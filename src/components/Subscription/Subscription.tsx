...
function Subscription() {
  ...
  const [pageloadingPlan, setPageloadingPlan] = useState(false);
  ...
  return (
    <div className="dialog-overlay">
      <div className="subscription">
        ...
        {subscribed ? (
          <div className="subscribed-page">
            <div className="main-body">
              ...
              <div>
                <img
                  src="https://static.vecteezy.com/system/resources/thumbnails/012/872/158/small/party-icon-confetti-popper-illustration-png.png"
                  alt=""
                />
              </div>
              <div>
                ...
                <p>
                  Now you have access to Pragpath marketplace. Enjoy the
                  enhanced experience!
                </p>
              </div>
            </div>
          ...
          <div className="header">
            <h2>
              Try ProgPath Premium
              {!isTrialUsed &&
                freePlan &&
                `, Free For ${freePlan?.durationValue} ${getDurationUnit(
                  freePlan?.durationValue,
                  freePlan?.durationType
                )}`}
            </h2>
            ...
            <div className="features">
              <div className="normal">
                <h4>Normal Users</h4>
                <p>
                  <i className="bi bi-emoji-smile-upside-down"></i>No Access to
                  Upload in Marketplace
                </p>
                <p>
                  <i className="bi bi-emoji-smile-upside-down"></i>Limited to 10
                  Workspaces
                </p>
                <p>
                  <i className="bi bi-emoji-smile-upside-down"></i>Limited to 10
              ...
              <div className="premium">
                <h4>Premium Users</h4>
                <p>
                  <i className="bi bi-check-circle-fill"></i>Access to Upload in
                  Marketplace
                </p>
                <p>
                  <i className="bi bi-check-circle-fill"></i>Create Unlimited
                  Workspace
                </p>
                <p>
                  <i className="bi bi-check-circle-fill"></i>Create Unlimited
            ...
            <p style={{ fontWeight: "lighter" }}>
              Join our exclusive community to upload and market your project
              ideas on ProgPath
            </p>
          </div>
        )}
        ...
        {subscribed && (
          <h3 style={{ textAlign: "center", color: "var(--color-violet)" }}>
            "You’re subscribed! Upgrade your plan anytime for extended
            validity."
          </h3>
        )}
          ...
          <div className="cards">
            {freePlan && !isTrialUsed && (
              <div className="card">
                ...
                <div>
                  <h3>
                    Get Free <br /> For {freePlan.durationValue}{" "}
                    {getDurationUnit(
                      freePlan.durationValue,
                      freePlan.durationType
                    )}
                ...
                <button
                  onClick={() => subscribeToTrial(freePlan._id)}
                  className={
                    loadingPlan === freePlan._id
                      ? "btn-disabled"
                      : "btn-secondary"
                  }
                >
              ...
              pricedPlans.map((plan: any) => (
                <div key={plan?._id} className="card">
                  ...
                  <div>
                    ...
                    <small>
                      {plan.durationValue}{" "}
                      {getDurationUnit(plan.durationValue, plan.durationType)}
                    </small>
                  </div>
                  <button
                    onClick={(e) => handleSubscribe(e, plan.price, plan._id)}
                    className={
                      loadingPlan === plan._id ? "btn-disabled" : "btn-primary"
                    }
                  >
