...
const TaskSearchFilterSort:React.FC<any> = ({
    ...
    const [filterByStatus] = useState(['Not Started', 'In Progress', 'Done', 'Stuck']);
  ...
  return (
    ...
    <div className='taskSearchFilterSort'>
                    ...
                    <ul>
                        ...
                        <li className='listOptions'>                            
                            <div className="custom-date-filter">
                                ...
                                {currentDateOption === 'custom' && <button className='btn-tertiary' id='apply-button' onClick={cancelCustomDateFilter}>Cancel</button>}
                                <button className='btn-secondary' id='apply-button' onClick={handleApplyCustomDate}>Apply</button>
                            </div>                       
                        </li>
                        ...
                        <li className='listHeading'>Task Due</li>
                        {
                            filterByDates.map((opt) => (                                
                                <li  key={opt} onClick={()=> handleFilterByDate(opt)} className='listOptions'>                                    
                                    {opt === 'today' && 'Today'}
                ...
                <div className='sortBy'>
                    <div onClick={() => dropDown === 'sort' ? setDropDown('') : setDropDown('sort')} className='sortBySwitch'>
                        <span>Sort</span> &nbsp;
                        <i className="bi bi-sort-alpha-down" style={{fontSize: 'small'}}></i>
                    </div>
