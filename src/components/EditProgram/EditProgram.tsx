...
const EditProgram: React.FC<AddProgramProps> = ({
  programId,
  setEditForm,
  setPrograms,
}) => {
      ...
      onSuccess: async () => {
        try {
          ...
          if (
            ...
            return dispatch(
              notify({
                message: `All images cannot be deleted! Atleast one image is required`,
                type: "error",
              })
            );
          }
          ...
          const { data } = await axios.delete(
            `/profile/programs/${programId}/images/${encodedImageKey}`
          );
      ...
      >
        ...
        <div className="image-group">
          <label htmlFor="image-one">
            <img
              src={
                imageOne ? imageOne?.imageUrl : "/images/image-placeholder.jpg"
              }
              alt="img-1"
            />
            <input
            ...
            {imageOne && (
              <i
                onClick={(e) => handleDeleteImage(e, 1, imageOne?.key)}
          ...
          <label htmlFor="image-two">
            <img
              src={
                imageTwo ? imageTwo.imageUrl : "/images/image-placeholder.jpg"
              }
              alt="img-2"
            />
            <input
            ...
            {imageTwo && (
              <i
                onClick={(e) => handleDeleteImage(e, 2, imageTwo?.key)}
                className="fa-solid fa-trash fa-lg"
              ></i>
            )}
            {imageLoading === 2 && (
          ...
          <label htmlFor="image-three">
            ...
            {imageThree && (
              <i
                onClick={(e) => handleDeleteImage(e, 3, imageThree?.key)}
                className="fa-solid fa-trash fa-lg"
              ></i>
            )}
            {imageLoading === 3 && (
